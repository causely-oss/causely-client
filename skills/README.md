...
| **causely-change-impact** | Post-deploy validation, regression checks, rollouts | reliability_delta, fleet_reliability_delta, get_service_summary, triage |
...
| **causely-correlated-incidents** | Multi-service outages, blast radius, cascading failures | get_root_causes, get_symptoms, get_topology, get_alerts |
...
| **causely-postmortem** | Incident retrospectives, ticket generation | postmortem, generate_ticket, name_lookup |
| **causely-alert-triage** | Alert investigation from PagerDuty/Datadog/Alertmanager | get_alerts, investigate_alert, get_root_causes, get_service_summary |
...
reliability_delta, team_health, triage
